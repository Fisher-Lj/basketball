...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.tabScrollView.frame = CGRectMake(0, HEIGHT_CONTENTVIEW, 320, HEIGHT_TABVIEW);
        ...
        self.tabSeprator = [[UIView alloc] initWithFrame:CGRectMake(0, HEIGHT_CONTENTVIEW, 320, 2)];
        ...
        self.emojiKeyboard = [[EmojiScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, HEIGHT_CONTENTVIEW)] ;
        self.emojiKeyboard.delegate = self;
        self.emojiKeyboard.emojis = [EmojiInfo defualtEmojis];
        [self addSubview:self.emojiKeyboard];
        
        self.stickerScrollView = [[StickerScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, HEIGHT_CONTENTVIEW)];
...
- (void)showInView:(UIView *)view emojiReceiver:(id<UIKeyInput>)receiver viewController:(UIViewController *)controller animated:(BOOL)animated
{
    ...
    if (view != nil)
    {
        ...
        if (animated)
        {
            self.frame = CGRectMake(origin.x, origin.y+HEIGHT_INPUTVIEW, 320, HEIGHT_INPUTVIEW);
            [UIView animateWithDuration:0.3 animations:^
             {
                 self.frame = CGRectMake(origin.x, origin.y, 320, HEIGHT_INPUTVIEW);
             }];
        }
        else
        {
